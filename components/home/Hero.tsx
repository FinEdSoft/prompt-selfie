...
export function Hero() {
  return (
    <div className="bg-black" >
      <div className="relative min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-cyan-900 via-gray-900 to-black text-white overflow-hidden">
        <BackgroundEffects />
          ...
          >
            ...
            >
              ...
              <div className="relative text-center max-w-3xl mx-auto space-y-8">
                <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-indigo-400 via-cyan-500 to-blue-500 bg-clip-text text-transparent">
                ...
                <SignedOut>
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Button
                      asChild
                      size="lg"
                      className="group bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-purple-700 hover:to-pink-700 cursor-pointer"
                    >
