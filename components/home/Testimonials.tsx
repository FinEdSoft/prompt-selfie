...
export function Testimonials() {
  return (
    <motion.div
      ...
      className="mt-32"
    >
      <h2 className="text-4xl font-bold text-center mb-4 bg-gradient-to-r from-cyan-400 to-indigo-500 bg-clip-text text-transparent">
        Loved by Creators
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <div>
              <p className="font-semibold bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">
                {testimonial.author}
              </p>
