    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {steps.map((step, index) => (
          ...
          >
            <div className="absolute -inset-4 bg-gradient-to-r from-cyan-600/20 to-indigo-600/20 rounded-xl opacity-0 group-hover:opacity-100 transition duration-500 blur-xl" />
            <div className="relative space-y-4 text-center p-6 rounded-xl bg-white/5 border border-white/10">
              <div className="w-12 h-12 mx-auto rounded-full bg-gradient-to-r from-cyan-500 to-indigo-500 flex items-center justify-center">
                {step.icon}
              </div>
