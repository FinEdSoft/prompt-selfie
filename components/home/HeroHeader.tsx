    ...
    >
      <div className="flex items-center justify-center gap-4 mb-6">
        <motion.span
          ...
          className="px-4 py-2 rounded-full bg-indigo-500/10 text-indigo-300 text-sm font-medium flex items-center gap-2 border border-purple-500/20"
        >
        ...
        <motion.span
          ...
          className="px-4 py-2 rounded-full bg-cyan-500/10 text-blue-300 text-sm font-medium flex items-center gap-2 border border-pink-500/20"
        >
          <Zap className="w-4 h-4" />
          Powered by FinEdSoft
        </motion.span>
      </div>

      <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight max-w-4xl mx-auto leading-tight">
        See Yourself Anywhere Instantly with{" "}
